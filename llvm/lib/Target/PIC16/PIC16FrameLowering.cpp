...
//===----------------------------------------------------------------------===//
//
// This file contains the PIC16TargetFrameLowering class.
//
//===----------------------------------------------------------------------===//
...
bool PIC16FrameLowering::hasFPImpl(const MachineFunction &MF) const {
  return false;
}
...
bool
PIC16FrameLowering::hasReservedCallFrame(const MachineFunction &MF) const {
  return true;
}
...
void PIC16FrameLowering::determineCalleeSaves(MachineFunction &MF,
                                              BitVector &SavedRegs,
